 ...
 * @param payload   Pointer to a payload type that will be filled with 
 *                  contents of the highest priority value from the queue. 
 *                  WARNING: the memory address of payload will be filled with 
 *                  payload_size data, so memory must be usable, free and non colliding
 * 
